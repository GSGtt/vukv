...
ob_start();
$API_KEY = '2077532868:AAFc3A1tXAWMXkV436-mDWoKc5dCzpGM3eU '; //add your bot token
...
if($text == 'مجهول or $text == "زياد"){
bot('sendContact',[
'chat_id'=>$chat_id,
'phone_number'=>" @xi_82 يسخر من الجروح كل من لا يعرف الألم ",
'first_name'=>" @xi_82 يسخر من الجروح كل من لا يعرف الألم ",
...
bot('sendMessage',[
'chat_id'=>$chat_id, 
'text'=>"🛠¦   قناة مـطـور الملف : @MitQx1☑️ ",
'reply_to_message_id'=>$message->message_id, 
]);
}
if($text == "🛠¦ المساعدة •"){
bot('sendMessage',[
'chat_id'=>$chat_id, 
'text'=>"💯¦ للمساعدة او اي أراء او افكار تواصل مع مطور الملف @xi_82 √",
'reply_to_message_id'=>$message->message_id, 
]);
}
if($you == "creator" or $you == "administrator" or $from_id == $sudo){
...
$id = $message->from->id;
// المتغيرات اللازمة //
$API_KEY = '2077532868:AAFc3A1tXAWMXkV436-mDWoKc5dCzpGM3eU'; // توكن البوت
